...
Whereas, doing a particular job for ten years doesn’t mean you can be an expert naturally. The key is deliberate practice, which means you should challenge yourself with tasks that are beyond your current ability, trying it and analysing it, correcting any mistakes you make. Then repeat and repeat. 
